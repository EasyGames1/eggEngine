...
namespace egg::Containers::Internal
{
    ...
    struct DenseMapNode final
    {
        ...
        constexpr explicit DenseMapNode(const std::size_t Position, Args&&... Arguments)
            : Next { Position },
        ...
        constexpr DenseMapNode(std::allocator_arg_t, const AllocatorType& Allocator, const std::size_t Position, Args&&... Arguments)
            : Next { Position },
        ...
        constexpr DenseMapNode(std::allocator_arg_t, const AllocatorType& Allocator, const DenseMapNode& Other)
            : Next { Other.Next },
        ...
        template <typename AllocatorType>
        constexpr DenseMapNode(std::allocator_arg_t, const AllocatorType& Allocator, DenseMapNode&& Other)
            : Next { Other.Next },
